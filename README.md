...
## Phase 13 — Social Enterprise Model

**เป้าหมาย:** รายได้เพื่อความยั่งยืน โดยบริการพื้นฐานฟรีเสมอ และเงินไม่เป็นเงื่อนไขในการคืนของ (`docs/SE_BUSINESS_MODEL.md`)

- [x] สินน้ำใจสำหรับผู้พบ (สมัครใจ) + ค่าดำเนินการ 2% (ปรับได้) — มอบหลัง Returned เท่านั้น, โหมดสาธิต
- [x] ผู้พบเลือกรับหรือมอบให้โครงการ
- [x] ผู้สนับสนุน/พันธมิตร + คูปองขอบคุณผู้พบอัตโนมัติ
- [x] บันทึกรายได้ (ค่าบำรุงระบบจากสถาบัน, ค่าสนับสนุน, บริจาค) + Dashboard SE
- [x] หน้าสาธารณะ: ผลลัพธ์ทางสังคม (`/impact`), ผู้สนับสนุน (`/sponsors`)
- [ ] Validation ราคา/ค่าธรรมเนียมกับผู้ใช้ สถาบัน และร้านค้า
- [ ] ขออนุมัติรูปแบบการรับชำระเงินจริงจากสถาบันก่อนเปิดใช้เงินจริง

**Deliverable:** `docs/PHASE_13_README.md`, migration 0028, ชุดทดสอบ `phase13_social_enterprise.test.sql`
